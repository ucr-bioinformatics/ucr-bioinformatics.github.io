...
md2Jekyll <- function(mdfile="Rbasics.knit.md", sidebartitle=NULL, sidebarpos, outfilebasename=NULL, outpath="./", sidebar_url_path="./", fenced2highlight=TRUE, image_dir=NULL) {
    ...
    filenames <- paste0(gsub("/$", "", outpath), "/main_", outfilebasename, "_", filenumbers, ".md")
    ...
    ## (9) Copy R Markdown *.html and *.pdf to pages/main. This makes it easier to render files on GitHub
    ...
    ## (10) Register new files in sidebar (_data/sidebars/site_sidebar.yml)
    sb <- readLines("../../_data/sidebars/site_sidebar.yml") 
    splitFct <- function(sb, pattern) {    
        ...
        if(length(splitpos) != 0) {
            ...
            stop("site_sidebar.yml is expected to contain at least one component.")
        }
    }
    ...
    sidebarfile <- paste0(sidebar_url_path, "/", "site_sidebar.yml")
...
# source("../md2jekyll.R")
# md2Jekyll(mdfile="bioassayR.knit.md", sidebartitle=NULL, sidebarpos=12, outfilebasename=NULL, outpath="../../main", sidebar_url_path="../../_data/mydoc/", fenced2highlight=TRUE, image_dir=NULL)
...
myargs <- commandArgs()
md2Jekyll(mdfile=myargs[6], sidebartitle=NULL, sidebarpos=as.numeric(myargs[7]), outfilebasename=NULL, outpath="../../pages/main", sidebar_url_path="../../_data/sidebars/", fenced2highlight=FALSE, image_dir=NULL)
